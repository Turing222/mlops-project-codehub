...
项目级规范、流程、部署、参考、评估与历史文档统一从 [docs/README.md](docs/README.md) 进入。分类清单与命名约定只在该页面维护。
...
| [frontend/docs/README.md](frontend/docs/README.md) | 前端架构与编码标准 |
| [evals/README.md](evals/README.md) | RAG 评测流程 |
| [perf/README.md](perf/README.md) | 性能压测入口 |
